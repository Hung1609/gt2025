# Present graph G using adjacency matrix: (S,E,W) = [(A,C,1),(A,B,4),(C,F,7),(B,F,3),(C,D,8),(D,H,5),(F,H,1),(F,E,1),(E,H,2),(H,G,3),(H,M,7),(H,L,6),(G,L,4),(E,L,2),(G,M,4),(L,M,1)]
# Implement Dijkstra's algorithm that obey following behavior:
# + Ask input Source (S) and target
